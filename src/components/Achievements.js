...
function Achievements() {
    ...
    const engineerMessage = "I've been a professional software engineer for eight years across two companies and have designed and deployed many features, microservices and platforms in that time. These are some of the more noteable ones. An automated review scraping tool designed to visit websites and store the reviews in a consolidated list. Partner to this was a review management platform where clients could manage and solicit reviews from their customers. I have also built a calendar grid based scheduling tool designed for managers to rapidly adjust technician schedules based on availability changes resulting from service cancellations and high priority calls."
